...
//        self.numberCredcard.anchor(top: self.topAnchor, leading: self.leadingAnchor, bottom: nil, trailing: self.trailingAnchor, padding: .init(top: 60, left: 10, bottom: 0, right: 10), size: .init(width: 0, height: 30))
        ...
        self.nameOwnerCredcard.anchor(top: self.layoutMarginsGuide.topAnchor, leading: self.leadingAnchor, bottom: nil, trailing: self.trailingAnchor, padding: .init(top: 60, left: 10, bottom: 0, right: 10), size: .init(width: 0, height: 30))
